...
| [Qorvo CMD319C3](https://aianalog.github.io/AID-demos/qorvo-CMD319C3/) | GaAs MMIC LNA/switch · gain, NF, P1dB vs frequency & bias |
| [Narda-MITEQ CLNA](https://aianalog.github.io/AID-demos/narda-miteq/) | Cryogenic LNA · bilinear grid interpolation, VT bias sliders |
| [28nm VCO](https://aianalog.github.io/AID-demos/28nm-VCO/) | 28nm CMOS voltage-controlled oscillator |
...
- **Interactive charts** replacing fixed datasheet plots with live sliders and real-time evaluation
- **Design-space exploration** — ML-augmented tools for faster analog design iteration
- **Physics-anchored interpolation** built from manufacturer-digitized data at 600 DPI
